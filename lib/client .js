...
try {
    ...
    console.log("📡Connected to the QUEEN-SENU-MD SERVER")
} catch {
...
let cc = Config.sessionName.replace(/QUEEN-SENU-MD;;;/g, "");
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/CyberKillersTEAM/QUEEN-SENU-MD')
	}
    }
    main()
    //========================================================================================================================================
 ...
 Void.ev.on('group-participants.update', async(anu) => {
        ...
        Void.ev.on('connection.update', async(update) => {
                ...
                if (connection === 'open') {
                    ...
                    console.log("✅ Queen-Senu-Md External Plugins Installed!");
...
app.listen(port, () => console.log(`QUEEN-SENU-MD Server listening on port http://localhost:${port}!`));
